...
function EditPro(props) {
  ...
  ></input>
      ...
      <img src={URL.createObjectURL(selectedImage) || url}  alt="not loaded"/>
      </div>
  ...
  <TextField  fullWidth value={linkedin} label='LinkedIn' onChange={(e)=>{setlinkedin(e.target.value)}} placeholder="Enter your Linkedin" />
<TextField  fullWidth value={instagram} label='Instagram' onChange={(e)=>{setinstagram(e.target.value)}} placeholder="Enter your instagram" />
<TextField  fullWidth value={github}label='Github' onChange={(e)=>{setgithub(e.target.value)}} placeholder="Enter your job github" />
