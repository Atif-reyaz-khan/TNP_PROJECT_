...
const[user,setUser]=useState('');
    ...
    useEffect(() => {
      ...
      axios.get(`/students/getbyid/${user}`)
...
>
 ...
 label='CTC' onChange={(e)=>{setctc(e.target.value)}} placeholder="Enter your CTC" />
         ...
         ></input>
             ...
             <img src={URL.createObjectURL(selectedImage)}  alt="no loaded"/>
             </div>
         ...
         ></input>
             ...
             <div className="upImg">
             <img src={"https://www.annauniv.edu/DIST/assests/images/upload_images/no-photo.gif"}  alt="not loaded"/>
             </div>
  ...
  // eslint-disable-next-line
  <div><Interview_Data setshowExp={settog} company={company} content={content}/></div>}
