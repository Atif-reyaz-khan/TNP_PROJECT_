...
function Card(props) {
    ...
    props.setreg(true);
        ...
        props.setinstagram(props.instagram);
        props.setgithub(props.github);
        props.setlinkedin(props.linkedin);
    }
    
    return (
        <div className="card">
        <div className="upper-container" style={{ backgroundImage: `url(/company_logo/${company}.jpeg)`, backgroundSize: '300px 100px',backgroundColor:'linear-gradient(to left,#8ea1f3,#86d5f5)'}}>
